...
const sampleCuratedData = {
  teams: {
    cse: {
      accomplishments: [
        { signal: 'Implemented Terraform management for the termed-user attribute with prevent-destroy safeguards.', sources: [{ type: 'jira', key: 'DWDEV-9407' }], confidence: 0.7 },
        { signal: 'Configured SSO for new vendor portal via Okta integration.', sources: [{ type: 'jira', key: 'DWS-123' }], confidence: 0.5 }
      ],
      inProgress: [
