...
const DB_DIR = process.env.RETICLE_DATA_DIR || path.join(process.env.HOME, '.reticle', 'data');
const DB_PATH = process.env.RETICLE_DB_PATH || path.join(DB_DIR, 'reticle.db');
...
function initDatabase() {
  if (!process.env.RETICLE_DB_PATH) {
